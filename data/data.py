...
class CommentDataset(Dataset):
    def __init__(self, data_dir, columns=['text','stars'], split_name='train', embedder='en_core_web_sm', embedding='sentence', transform=None,**kwargs):
        ...
        embedding_method = embedder.sentence_embedding if embedding=='sentence' else embedder.word_embedding
        self.transform = transform
        self.key = 'sent_embed' if embedding=='sentence' else 'word_embed'
