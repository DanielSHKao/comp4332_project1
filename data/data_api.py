...
class CommentDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage: str):
        self.train_set = CommentDataset(self.data_dir, columns=['text','stars'], split_name='train')
        self.val_set = CommentDataset(self.data_dir, columns=['text','stars'], split_name='valid')
        self.test_set = CommentDataset(self.data_dir, columns=['all'], split_name='test')
